...
public:
    ...
    // Set size immediately via layer-shell protocol (call from main thread only).
    // Respects the anchor_top|anchor_right anchor — window grows downward, not from center.
